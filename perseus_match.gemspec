...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/perseus_match/list.rb", "lib/perseus_match/version.rb", "lib/perseus_match/token_set.rb", "lib/perseus_match/cluster.rb", "lib/perseus_match.rb", "bin/perseus_match", "Rakefile", "COPYING", "ChangeLog", "LINGO_BASE", "README", "spec/spec_helper.rb", "spec/perseus_match/list_spec.rb", "spec/perseus_match/cluster_spec.rb", "spec/perseus_match/token_set_spec.rb", "spec/perseus_match_spec.rb"]
  s.has_rdoc = true
